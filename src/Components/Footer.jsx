...
export default function Footer() {
  return (
    <footer
      className="bg-[#020617] text-white pt-20 pb-12 overflow-hidden"
      dir="rtl"
    >
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20 text-right">
          ...
          <div className="flex flex-col items-center order-1">
            ...
            <h4 className="text-2xl font-bold mb-6">
              {" "}
              <a href="https://wa.link/cbcz1x" target="blank">
                تواصل معنا
              </a>
            </h4>
            <div className="space-y-4 w-full">
              <a
                href="tel:+966565593442"
                className="flex items-center justify-center gap-3 text-gray-400 hover:text-blue-500 transition-colors group"
              >
              ...
              <a
                href="mailto:flowsystem.gmb@gmail.com"
                className="flex items-center justify-center gap-3 text-gray-400 hover:text-blue-500 transition-colors group"
              >
                <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white shadow-[0_0_15px_rgba(37,99,235,0.4)]">
                  <Mail size={18} />
                </div>
                <a href="mailto:flowsystem.gmb@gmail.com" className="text-lg">
                  flowsystem.gmb@gmail.com
                </a>
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start order-3 md:order-3">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.tiktok.com/@flow.gmb"
                target="blank"
                aria-label="تيك توك"
                className="w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center text-white hover:bg-blue-500 transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)]"
              >
                <FaTiktok size={22} />
              </a>
              <a
                href="https://www.instagram.com/flow.gmb"
                target="blank"
                aria-label="انستغرام"
                className="w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center text-white hover:bg-blue-500 transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)]"
              >
              ...
              <a
                href="https://www.snapchat.com/@flow.gmb"
                target="blank"
                aria-label="سناب شات"
                className="w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center text-white hover:bg-blue-500 transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)]"
              >
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col items-center">
          ...
          {/* <p classNme="text-gray-100 text-sm hidden">
            Made By Dev | 
            <a href="https://codezeesocialist.vercel.app/" target="blank">
              Zeyad Muhammad Khalil
            </a>
          </p> */}
        </div>
      </div>
