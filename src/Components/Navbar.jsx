    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 
      ...
      <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="hidden md:block">
          <a href='https://wa.link/cbcz1x' target='blank' className="bg-primary hover:bg-blue-800 text-white px-2 py-3 border border-white flex items-center gap-2 transition-all group">
            تواصل معنا
          </a>
        </div>
      ...
      {isMobileMenuOpen && (
        <div id="mobile-menu" className="md:hidden bg-slate-900/95 backdrop-blur-lg absolute top-full left-0 right-0 py-6 px-6 shadow-xl border-t border-white/10">
          <ul className="flex flex-col gap-6 text-center text-white">
            ...
            <li>
              <a href='https://wa.link/cbcz1x' target='blank' className="bg-blue-600 hover:bg-blue-700 text-white w-full py-3 rounded-lg flex justify-center items-center gap-2 transition">
                تواصل معنا
