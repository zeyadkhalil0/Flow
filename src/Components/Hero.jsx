      ...
      <div className="container flex flex-col mx-auto px-6 md:px-12 text-center">
        ...
        >
          <a
            ...
            className="btn-primary bg-primary text-white font-bold cursor-pointer flex items-center gap-3 px-2 py-2 text-lg border border-black"
          >
            اطلب خطة مشروعك الان
            <ArrowLeft className="w-5 h-5" />
          </a>
          <a href="https://drive.google.com/drive/folders/1Y-cImKI3ODxiplOrXy6kVr-1cGddYgaa?usp=sharing" target="blank" className="btn outline outline-black cursor-pointer bg-white px-2 py-2 text-md md:text-lg">
            عرض الملف التعريفي
          </a>
        </div>
      </div>
